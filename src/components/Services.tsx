...
import { mockupFor } from '@/components/services/ServiceMockups';
    ...
    <section id="services" className="container-section">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {data.map((service, index) => {
          const Mockup = mockupFor(service.title);
          return (
            <div
              key={index}
            ...
            >
              <div className="aspect-video w-full overflow-hidden border-b border-gray-100 dark:border-gray-700">
                {Mockup ? (
                  <Mockup />
                ) : (
                  <img
