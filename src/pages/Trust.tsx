...
const Trust: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* Ticket 0077 - cross-link chip to /ethics. Sits at the bottom of the
          page as the sibling public-trust-artifact pointer (the /ethics page
          is a passive dated hard-NO list; the CTA is the URL itself, which a
          compliance reviewer forwards to a procurement file). One chip only;
          the existing sections, disclosure list, providers card, and JSON-LD
          blocks above are byte-identical to the ticket 0044 shipped state. */}
      <section className="py-8 bg-white dark:bg-gray-950 border-t border-gray-100 dark:border-gray-800">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="flex flex-wrap gap-3 justify-center">
            <Link
              to="/ethics"
              data-testid="trust-ethics-link"
              ...
              onClick={() => trackCTAClick('ethics_from_trust', 'trust_footer')}
            >
              What we won't do
              <ArrowRight size={14} />
            </Link>
