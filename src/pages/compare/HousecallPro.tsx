...
// Ticket 0074 - tool name mirrors the H1 "DigitalCraft AI vs Housecall Pro"
// and the COMPARE_ENTRIES.tool value; used by recordCompareVisit for the
// /my RecentComparesCard.
const TOOL_NAME = 'Housecall Pro';
