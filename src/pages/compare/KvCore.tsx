...
// Ticket 0086 - "Digital Craft vs kvCORE" comparison page for
// real-estate CRM switchers ("kvCORE alternative", "kvCORE vs", "AI for
// real estate CRM", "kvCORE Follow Up Boss comparison"). Modeled 1:1 on
// src/pages/compare/FollowUpBoss.tsx (ticket 0065, the direct real-
// estate-vertical peer at similar file size AND hub-aware breadcrumb
// shape). Structural notes: kvCORE bundles IDX websites, squeeze-page
// lead capture, CRM, drip campaigns, and smart plans around a single
// contact record - so the positioning is complement-not-replace and the
// four dimensions are Lead capture, First response, Qualification, and
// Voice negotiation per the ticket. Demo CTAs route to
// /realestate/demo/* (the three real-estate demos ticket 0065 already
// funnels into).
//
...
// src: https://www.insiderealestate.com (kvCORE product overview)
// src: https://www.insiderealestate.com/kvcore (feature bundle: IDX
//      websites, squeeze pages, smart CRM, smart plans, smart drips)

interface ComparisonRow { dimension: string; kvcore: string; dca: string; }
...
const COMPARISON_ROWS: ComparisonRow[] = [
  {
    ...
    kvcore: 'IDX website + squeeze pages capture leads into the CRM',
    dca: 'Answers form fills and calls in seconds, 24/7',
  },
  {
    dimension: 'First response',
    kvcore: 'Smart plans and drip texts fire on a schedule',
    dca: 'AI agent answers on the first ring or first form fill',
  },
  {
    dimension: 'Qualification',
    kvcore: 'Contact record stores stage, timeline, and notes for the agent',
    dca: 'AI qualifies buyer motivation and timeline in a live chat or call',
  },
  {
    dimension: 'Voice negotiation',
    kvcore: 'Not in scope - the assigned agent handles the call',
...
const DIFFERENTIATORS = [
  {
    ...
    desc: 'Digital Craft AI ships AI lead chat trained on your own scraped website, ready to sit alongside the kvCORE IDX pages. After-hours squeeze-page fills get qualified in-thread and the booking lands as a warm lead for the on-call agent. kvCORE stores the lead once it arrives, but it does not answer the buyer in the moment they filled the squeeze page.',
  },
  {
    icon: Mic,
    title: 'Live AI Voice Answering And Negotiation',
    desc: 'Every Digital Craft AI plan ships AI voice agents that answer the phone in your brokerage name, qualify the buyer or seller, and can negotiate a property deal on a live call. kvCORE does not answer your phone; leads who call after 5pm still hit voicemail while the smart plan waits for the next scheduled text.',
  },
  {
    icon: Zap,
    title: 'Deal Analysis The Real-Estate CRM Was Not Built For',
    desc: 'Digital Craft AI runs comps, ARV, and bid-range analysis from a property URL or address in seconds, then drafts the seller-outreach message. kvCORE tracks the contact through the funnel; Digital Craft AI does the deal math and outreach copy the agent would otherwise draft by hand.',
  },
];
...
const CRUMBS: ReadonlyArray<Crumb> = [
  ...
  { name: 'Digital Craft vs kvCORE', href: '/compare/kvcore', url: 'https://digitalcraftai.com/compare/kvcore' },
];

const SITE_URL = 'https://digitalcraftai.com';

const PAGE_H1 = 'Digital Craft AI vs kvCORE';
const PAGE_NAME = 'Digital Craft AI vs kvCORE Comparison';
const META_DESCRIPTION =
  'Compare Digital Craft AI and kvCORE honestly. kvCORE is a residential real-estate operating system that bundles IDX websites, squeeze-page lead capture, CRM, and smart-plan drip campaigns. Digital Craft AI is the AI agent layer that answers those leads in seconds, qualifies them by chat or voice, and can negotiate deals live. The two are complements, not substitutes - kvCORE keeps the pipeline and the site, the AI layer works the leads.';
...
const KvCoreComparison: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <Helmet>
        <title>Digital Craft AI vs kvCORE | Answer The Leads Your CRM Stores</title>
        <meta name="description" content={META_DESCRIPTION} />
        <meta property="og:title" content="Digital Craft AI vs kvCORE | Honest Comparison" />
        <meta
          property="og:description"
          content="Side-by-side comparison of Digital Craft AI and kvCORE for real-estate teams evaluating whether the AI agent layer replaces the IDX-plus-CRM bundle or sits on top of it."
        />
        <link rel="canonical" href="https://digitalcraftai.com/compare/kvcore" />
      ...
      <section className="pt-8 pb-16 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-white">
            {PAGE_H1.split(' vs ')[0]} vs <span className="text-primary">kvCORE</span> for Real-Estate Teams Tired of Unanswered Leads
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-4 max-w-2xl mx-auto">
            kvCORE is a residential real-estate operating system that bundles IDX websites, squeeze-page lead capture, CRM, and smart-plan drip campaigns for brokerages and teams. Digital Craft AI is the AI agent layer that answers those leads the moment they arrive, qualifies them by chat or voice, and can negotiate a deal live. The two are complements, not substitutes.
          </p>
      ...
      <section className="py-16 bg-white dark:bg-gray-950">
        <div className="container mx-auto px-4 max-w-4xl">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-900">
                  ...
                  <th className="px-6 py-4 text-sm font-semibold text-center text-gray-500 dark:text-gray-400 w-1/3">kvCORE</th>
              ...
              <tbody>
                {COMPARISON_ROWS.map((row, i) => (
                  <tr
                    key={row.dimension}
                    data-testid="kvcore-comparison-row"
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center"><span className="text-sm text-gray-700 dark:text-gray-300">{row.kvcore}</span></td>
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-4 text-center">
            * kvCORE publishes plan pricing through Inside Real Estate at insiderealestate.com. Bundle contents and per-seat costs change over time; check the kvCORE product page before renewing.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">Both products solve a real problem. Here is where Digital Craft AI adds capabilities kvCORE does not.</p>
      ...
      <section className="py-16 bg-white dark:bg-gray-950">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="p-8 rounded-2xl border border-primary/30 dark:border-primary/40 bg-gray-50 dark:bg-gray-900">
            ...
            <h2 className="text-xl md:text-2xl font-bold mb-3 text-gray-900 dark:text-white">kvCORE For The IDX Site And Pipeline, Digital Craft AI For First Touch And Voice Negotiation</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              The honest position: kvCORE and Digital Craft AI are complements, not substitutes. kvCORE owns the IDX website, the squeeze-page lead capture, and the CRM record every agent works from. Digital Craft AI answers the lead in seconds, qualifies it, and either books the appointment or drops the qualified lead back into kvCORE for the assigned agent to work.
            </p>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              Plenty of the teams we work with keep their kvCORE seats and add the AI layer alongside for first-touch, after-hours, and live voice negotiation. The 48-hour setup with no annual commitment means you can test the combination without renegotiating the kvCORE contract.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            <Link
              ...
              data-testid="comparekvcore-demo-cta"
              ...
              onClick={() => trackCTAClick('try_lead_responder', 'comparekvcore_demo_lead_responder')}
            >
            ...
            <Link
              ...
              data-testid="comparekvcore-demo-cta"
              className="inline-flex flex-col items-center justify-center gap-2 px-6 py-5 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 hover:border-primary dark:hover:border-primary rounded-xl transition-colors"
              onClick={() => trackCTAClick('try_property_negotiator', 'comparekvcore_demo_property_negotiator')}
            >
            ...
            <Link
              ...
              data-testid="comparekvcore-demo-cta"
              className="inline-flex flex-col items-center justify-center gap-2 px-6 py-5 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 hover:border-primary dark:hover:border-primary rounded-xl transition-colors"
              onClick={() => trackCTAClick('try_voice_negotiator', 'comparekvcore_demo_voice_negotiator')}
            >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              onClick={() => trackCTAClick('book_call', 'comparekvcore_strategy_call')}
            >
              <Calendar size={18} />
            ...
            <a
              ...
              onClick={() => trackCTAClick('call_us', 'comparekvcore_phone')}
            >
              <Phone size={14} />
              or call us
            </a>
          </div>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-6">Already running kvCORE? Keep the seats that work, add the AI agent layer on top.</p>
        </div>
      </section>
...
export default KvCoreComparison;
