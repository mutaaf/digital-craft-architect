...
import { Scale, ArrowRight, Rss } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="py-10 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          ...
          {/* Ticket 0095 - additive footer chip pointing at the public
              JSON Feed 1.1 emission at /compare.json (generated by
              scripts/generate-compare-json.ts on every `npm run build`).
              Label is authored here once and rendered from this single
              source (2026-05-25 mirror-source rule). */}
          <div className="mt-6 flex justify-center">
            <a
              href="/compare.json"
              data-testid="compare-json-feed-link"
              onClick={() =>
                trackCTAClick('compare_subscribe_json', 'compare_hub_footer')
              }
              className="inline-flex items-center gap-2 rounded-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:border-primary dark:hover:border-primary hover:text-primary dark:hover:text-primary transition-colors"
            >
