...
| 0079 | Emit CollectionPage plus ItemList plus BreadcrumbList JSON-LD on the /blog index so the blog indexes as a canonical article collection | P1 | in-progress | seo |
| 0080 | AI-for-moving-companies long-tail landing page funneling into home-services demos | P1 | groomed | content |
