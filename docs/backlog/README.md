...
| 0027 | "More like this" cross-vertical recommendations under each demo | P1 | in-progress | demos |
| 0028 | Comparison page "Digital Craft vs ServiceTitan" for high-intent field-service compares | P1 | groomed | seo |
