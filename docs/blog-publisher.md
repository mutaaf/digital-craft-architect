...
- **Never invent a customer.** No fabricated case studies, companies, cities, or testimonials. Inventing a plausible-sounding client ("a contractor in Denver went from a 20% to a 30% close rate") is banned even as illustration: a reader cannot tell an invented example from a real one, so on a marketing site it reads as a claim about our results. If you have no real, verifiable source, do not imply one exists. Write the mechanism instead of a fake proof point. This is an automatic BLOCK at review.
  - **The existing posts dated 2026-03-26 through 2026-05-20 are NOT examples of this.** Their figures, including the 92% response-time case study and the plumbing-contractor close-rate numbers, are real client results, confirmed by the site owner on 2026-09-06. They are accurate and they stay.
  - The rule still binds you completely, because the asymmetry is about access, not about style: the owner can cite client outcomes because the owner has the data. You do not have it. A figure you cannot trace to something in this repo or to a source you can name is invented by definition, however plausible it feels. When you want a proof point and have no source, write the mechanism.
